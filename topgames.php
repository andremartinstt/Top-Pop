...
<body>
	...
	<section class="jumbotron">
		<div class="container">
			<h1>Games</h1>
			<p>Ranking dos jogos em geral</p>
		</div>
	</section>
		...
		<div class="row">
			<section class="col-md-9">
				<?php
					...
					$num_total = $connection->query("SELECT * FROM noticias WHERE categoria_noticia = 'games'")->num_rows; // Qtd de registros
					...
					$sql = "SELECT * FROM noticias WHERE categoria_noticia = 'games' order by id_noticia desc LIMIT $pagina_result, $itens_pag";
				...
				<nav class="nav-pagination">
					<div class="center-block">
						<ul class="pagination">
							...
							?>
							<li <?php echo $dis_ini; ?> ><a href="topgames.php?pagina=<?php echo $pagina-1 ?>">&laquo;<span class="sr-only">Anterior</span></a></li>
							<?php
								for ($i=1; $i <= $num_paginas ; $i++) { 
									...
									if($pagina == $i)
										$estilo = "class=\"active\"";
							?>
							<li <?php echo $estilo; ?> ><a href="topgames.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
							<?php } ?>
							<li <?php echo $dis_ult; ?> ><a href="topgames.php?pagina=<?php echo $pagina+1; ?>">&raquo;<span class="sr-only">Próximo</span></a></li>
						</ul>
					</div>
				</nav>
